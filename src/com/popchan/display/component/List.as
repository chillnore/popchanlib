package com.popchan.display.component
{
	...
	public class List extends Component
	{
		...
		public function List(parent:DisplayObjectContainer=null, x:Number=0, y:Number=0,skinName:String="Skin_scrollbar")
		{
			super(parent, x, y);
			this.skin=skinName;
		}
		...
		override protected function config():void
		{
			...
			_scrollBar=new ScrollBar(this,0,0);
		...
		override protected function draw():void
		{
			...
			{
				_scrollBar.skin=_skin;
				_back.bitmapData=ResourceManager.getBitmapData("Skin_list_bg");
